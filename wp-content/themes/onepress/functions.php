...
add_action( 'wp_enqueue_scripts', 'image_animate_my_script' );
function image_animate_my_script() {
    wp_enqueue_script(
        'imageanimation', // name your script so that you can attach other scripts and de-register, etc.
        get_template_directory_uri() . '/assets/js/imageanimation.js', // this is the location of your script file
...
add_filter( 'show_on_home-old_page', '__return_true' );
add_filter( 'show_on_front_page', '__return_true' );
add_filter( 'show_on_product_page', '__return_true' );

add_action( 'user_registration_user_form_submit', 'bks_save_mobile_field' );
