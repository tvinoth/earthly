...
<div class="xoo-wsc-products" style="border:0px solid !important;">
	...
	foreach ( $cart as $cart_item_key => $cart_item ) {
		...
		$product_short_name 		= $_product->get_short_description();
		...
		$thumbnail 			= $product_permalink && $showPLink ? $thumbnail  : $thumbnail;
